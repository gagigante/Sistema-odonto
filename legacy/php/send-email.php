<?php 
    ...
    if($result->num_rows>0) {
        while ($dados = $result->fetch_assoc()) {            
            ...
            $user_hash = md5($user_id) . "/" . md5($user_email);
        }        
