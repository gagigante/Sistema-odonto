        ...
        <form class="form">
            ...
            <div class="form-row">                        
                <div class="form-group col-md-12">                            
                    ...
                    <input type="password" class="form-control" name="confirm-password" id="confirm-password" autocomplete="off" required>
                </div>
            </div>   
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">                         
                    <button onclick="window.location.href = 'login.php'" type="button" class="btn btn-success send-email">Ir para login</button>
                </div>
            </div>
        </div>
    </div>
